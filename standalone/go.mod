...
require (
	...
	github.com/aacfactory/fns-contrib/transports/handlers/documents v1.2.84
	github.com/aacfactory/fns-contrib/transports/handlers/pprof v1.2.84
	github.com/aacfactory/fns-contrib/transports/handlers/websockets v1.2.84
