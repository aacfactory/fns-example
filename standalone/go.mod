...
replace (
	github.com/aacfactory/fns v0.0.1 => ../../fns
	github.com/aacfactory/fns-contrib/authorizations/jwt v0.0.0-20210904003123-1e4b4c8b7f02 => ../../fns-contrib/authorizations/jwt
	github.com/aacfactory/fns-contrib/databases/sql v0.0.0-20210904003123-1e4b4c8b7f02 => ../../fns-contrib/databases/sql
)
