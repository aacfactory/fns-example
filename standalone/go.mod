...
replace (
	github.com/aacfactory/fns v1.0.1 => ../../fns
	github.com/aacfactory/fns-contrib/databases/sql v1.0.0 => ../../fns-contrib/databases/sql
)
...
require (
	...
	github.com/aacfactory/fns-contrib/databases/sql v1.0.0
