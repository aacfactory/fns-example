...
replace (
	...
	github.com/aacfactory/fns-example/cluster/posts v0.0.0 => ../posts
)
...
require (
	...
	github.com/aacfactory/fns-example/cluster/posts v0.0.0
...
require (
	...
	github.com/aacfactory/copier v1.2.1 // indirect
