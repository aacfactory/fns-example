module github.com/aacfactory/fns-example/cluster/users

go 1.21.0

require (
	github.com/aacfactory/fns v1.2.84
	github.com/aacfactory/fns-contrib/databases/postgres v1.2.84
	github.com/aacfactory/fns-contrib/databases/redis v1.2.84
	github.com/aacfactory/fns-contrib/databases/sql v1.2.84
	github.com/aacfactory/fns-example/cluster/posts v0.0.1
...
require (
	...
	github.com/aacfactory/errors v1.13.12 // indirect
	github.com/aacfactory/gcg v1.0.5 // indirect
